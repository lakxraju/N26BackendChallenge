 ...
 */
public class N26PriorityBlockingQueue<E> extends AbstractQueue<E>
...
/**
 * _______________________________________________________START OF CUSTOM FIELDS FOR BACKEND CHALLENGE____________________________________________________________________
 * */
     ...
     * @throws ClassCastException when the manipulated object is not an instance of TransactionBean
     * 
     **/
    @SuppressWarnings("unchecked")
	public void addToAllDS(TransactionBean txnBean)
    {
    ...
    /**
     *
     * Removes all elements that are older than 60 secs
     * 1. Locks the object
     ...
     * 
     **/
    public void pruneBucket(Long current_epoch_millis){
    	if(this.size()<1){
    		return;
    	}
    	while((current_epoch_millis - ((TransactionBean)this.peek()).getTimestamp()) > 60000){
    		final ReentrantLock lock = this.lock;
    		try{
	    		lock.lock();
    ...
    /**
     * _______________________________________________________END OF CUSTOM FIELDS FOR BACKEND CHALLENGE____________________________________________________________________
     * */
     ...
     */
    public N26PriorityBlockingQueue() {
     ...
     *         than 1
     */
    public N26PriorityBlockingQueue(int initialCapacity) {
     ...
     */
    public N26PriorityBlockingQueue(Collection<? extends E> c) {
